      ...
      <View style={styles.container}>
        ...
        <View style={styles.logo}>
          ...
          <View style={styles.logos}>
            ...
            <TouchableOpacity onPress={() => navigation.navigate('profil2')}>
              <HommeSvgComponent />
            </TouchableOpacity>
          </View>
        </View>
        ...
        <Tab.Navigator
          screenOptions={{
            ...
            tabBarStyle: { width: '100%', marginBottom: 2, borderColor: 'transparent', backgroundColor: '#FFF' },
           ...
           // tabBarBackground: () => <View style={{backgroundColor: '#FFF'}} />,
          }}
